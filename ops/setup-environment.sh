...
--from-literal=OXFORD_VISION_TOKEN="${cogsvc_vision_account_key}" \
--from-literal=OXFORD_LANGUAGE_TOKEN="${cogsvc_text_account_key}" \
--from-literal=OXFORD_SPEECH_TOKEN="${cogsvc_speech_account_key}"
